...
Можно собирать как ручками, так и использровать заготовленные команды для билда
...
ВАЖНО: надо запускать сервер перед запуском клиента, иначе клиент может завершиться/крашнуться
